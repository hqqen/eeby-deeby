...
r = []; a0 = []; alpha0 = [];
c = 1:ceil(Na/2); c = [-flip(c), 0, c(1:end-1)];
% setup disance bounds for Rxs
dMin = -5*lambda; dMax = 5*lambda;
for i = 1:Na

    r(:,i) = (dMax - dMin)*rand(2,1) + dMin;[lambda*c(i),0];
    % a0(i) = c(i)^3;
    % alpha0(i) = c(i)*pi/8;
...
% r = [xm, ym].';
% for 2023 updates
r = [19.9137591111752	-23.4845546584216	-4.08103494668254	15.7023623143554	-16.7981192251066	11.6323502980380	-28.5751738831218	34.4807968887061	6.39508132348330	18.8450294479240	0.446778874885680	29.3177439401849	3.54116474728523	-26.3029495830707	25.5537941987747	23.5713619551612	32.1947717390421	-22.7553562176594	8.70335071099794	-11.1255369702752	6.39480683645432;
...
legend("Tx", "Rx")
title("Agent and Reciever Positions")
xlabel("x(m)")
ylabel("y(m)")
set(gca,'FontSize',12)
grid on
