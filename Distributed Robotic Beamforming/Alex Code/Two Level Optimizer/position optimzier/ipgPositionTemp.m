...
for t = 1:T
    ...
    for agent = 1:Na
        for rec = 1:Ns
            uxx(agent,rec) = -a(agent)*((-mu*sin(alpha(agent) + zeta(agent,rec)) * (k*cos(tht(rec)) + k*(x(agent) - rho(rec)*cos(tht(rec)))*d(agent,rec)^-1) * (2*x(agent) - 2*rho(rec)*cos(tht(rec))) + 2*mu*cos(alpha(agent) + zeta(agent,rec)))*(4*d(agent,rec)^(2+mu/2)) ...
                - (mu*cos(alpha(agent) + zeta(agent,rec))*(2*x(agent) - 2*rho(rec)*cos(tht(rec)))*(2+mu/2)*(d(agent,rec)^(1 + mu/2))*(x(agent) - rho(rec)*cos(tht(rec)))*d(agent,rec)^-1)*(4*d(agent,rec)^(2+mu/2))^-2 ...
                + (((cos(alpha(agent) + zeta(agent,rec))*(k*cos(tht(rec)) + k*(x(agent) - rho(rec)*cos(tht(rec)))*d(agent,rec)^-1)*(k*cos(tht(rec)) + k*(2*x(agent) - 2*rho(rec)*cos(tht(rec)))*(2*d(agent,rec))^-1)) + sin(alpha(rec) + zeta(agent,rec))*(4*k*d(agent,rec) - k*(2*x(agent) - 2*rho(rec)*cos(tht(rec)))^2 * d(agent,rec)^-1)*(2*d(agent,rec))^-2)*d(agent,rec)^(mu/2)) ...
                - (sin(alpha(agent) - zeta(agent,rec)) * (k*cos(tht(rec)) + k*(2*x(agent) - 2*rho(rec)*cos(tht(rec)))*(2*d(agent,rec))^-1) * (mu/2) * (4*d(agent,rec)^(mu/2 - 1)) * (x(agent) - rho(rec)*cos(tht(rec)))*d(agent,rec)^-1)*(d(agent,rec)^(mu/2))^-2);
            uyy(agent,rec) = -a(agent)*((-mu*sin(alpha(agent) + zeta(agent,rec)) * (k*sin(tht(rec)) + k*(y(agent) - rho(rec)*sin(tht(rec)))*d(agent,rec)^-1) * (2*y(agent) - 2*rho(rec)*sin(tht(rec))) + 2*mu*cos(alpha(agent) + zeta(agent,rec)))*(4*d(agent,rec)^(2+mu/2)) ...
                - (mu*cos(alpha(agent) + zeta(agent,rec))*(2*y(agent) - 2*rho(rec)*sin(tht(rec)))*(2+mu/2)*(d(agent,rec)^(1 + mu/2))*(y(agent) - rho(rec)*sin(tht(rec)))*d(agent,rec)^-1)*(4*d(agent,rec)^(2+mu/2))^-2 ...
                + (((cos(alpha(agent) + zeta(agent,rec))*(k*sin(tht(rec)) + k*(y(agent) - rho(rec)*sin(tht(rec)))*d(agent,rec)^-1)*(k*sin(tht(rec)) + k*(2*y(agent) - 2*rho(rec)*sin(tht(rec)))*(2*d(agent,rec))^-1)) + sin(alpha(rec) + zeta(agent,rec))*(4*k*d(agent,rec) - k*(2*y(agent) - 2*rho(rec)*sin(tht(rec)))^2 * d(agent,rec)^-1)*(2*d(agent,rec))^-2)*d(agent,rec)^(mu/2)) ...
                - (sin(alpha(agent) - zeta(agent,rec)) * (k*sin(tht(rec)) + k*(2*y(agent) - 2*rho(rec)*sin(tht(rec)))*(2*d(agent,rec))^-1) * (mu/2) * (4*d(agent,rec)^(mu/2 - 1)) * (y(agent) - rho(rec)*sin(tht(rec)))*d(agent,rec)^-1)*(d(agent,rec)^(mu/2))^-2);
            vxx(agent,rec) = -a(agent)*((-(mu*cos(alpha(agent) + zeta(agent,rec))*(k*cos(tht(rec)) + k*(x(agent) - rho(rec)*cos(tht(rec)))*d(agent,rec)^-1) * (2*x(agent) - 2*rho(rec)*cos(tht(rec))) + 2*mu*sin(alpha(agent) + zeta(agent,rec)))*(4*d(agent,rec)^(2+mu/2)) ...
                              - (mu*cos(alpha(agent) + zeta(agent,rec))*(2*x(agent) - 2*rho(rec)*cos(tht(rec)))*(2+mu/2)*(d(agent,rec)^(1+mu/2))*(x(agent) - rho(rec)*cos(tht(rec)))*d(agent,rec)^-1))*(4*d(agent,rec)^(2+mu/2))^-2 ...
                              + (((cos(alpha(agent) + zeta(agent,rec))*(k*cos(tht(rec)) + k*(x(agent) - rho(rec)*cos(tht(rec)))*d(agent,rec)^-1)*(k*cos(tht(rec)) + k*(2*x(agent) - 2*rho(rec)*cos(tht(rec)))*(2*d(agent,rec))^-1)) ...
                              + sin(alpha(agent) + zeta(agent,rec))*(4*k*d(agent,rec) - k*(2*x(agent) - 2*rho(rec)*cos(tht(rec)))^2 * d(agent,rec)^-1 )*d(agent,rec)^(mu/2)) ...
                              - sin(alpha(agent) + zeta(agent,rec)) * (k*cos(tht(rec)) + k*(2(x(agent) - 2*rho(rec)*cos(tht(rec))))*(d(agent,rec))^-1) *(2*d(agent,rec))^(-2))*d(agent,rec)^(mu/2) ...
                              - )
        end
    end
    ...
    if isnan(noisyErrorDB(t)) | any(abs(x) > 2*rho(1)) | any(abs(y) > 2*rho(1))
