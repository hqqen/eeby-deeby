...
w = 1./f;
w = w/sum(w);
xm = [465;465;465;378;285];
ym = [465;376;195;285;465];
% xrec = [20.5;100.5];
% yrec = [200.5;155.5];
xrec = [20.5;200.5];
yrec = [200.5;0.5];
...
for m=1:N_a
    if m==1
        load('amat_465_465.mat');load('pmat_465_465.mat');
    end
    if m==2
        load('amat_465_376.mat');load('pmat_465_376.mat');
    end
    if m==3
        load('amat_465_195.mat');load('pmat_465_195.mat');
    end
    if m==4
        load('amat_378_285.mat');load('pmat_378_285.mat');
    end
    if m==5
        load('amat_285_465.mat');load('pmat_285_465.mat');
    end
    amat = amat/max(amat);
